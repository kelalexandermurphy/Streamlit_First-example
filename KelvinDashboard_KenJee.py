...
import pandas as pd                        #data structure malipulation
import numpy as np                         #Array and math
import plotly.graph_objects as go          #Graphs and outputs
import plotly.express as px                #To be determined
import streamlit as st                     #This librabry is used to set up the dashboard
from datetime import datetime              #Date and time stamp transformation
...
def load_data():
    ...
    # the first file contins most of the metrics use in the 
...
if add_sidebar == 'Aggregate Metrics':
    st.write("Kelvin's YouTube Aggregated Data")
